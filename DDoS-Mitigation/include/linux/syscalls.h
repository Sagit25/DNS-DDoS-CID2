...
// added by junjinyong
/*
asmlinkage int sys_puzzle_hash(int nonce, int target_ip, int target_port, int puzzle_type);

asmlinkage int sys_puzzle_solve(int threshold, int target_ip, int target_port, int puzzle_type);
*/
